...
public abstract class TileEntityItemInventoryDirectional extends TileEntityItemInventory implements ITileEntityRotatable {

    protected EnumFacing frontFacing = EnumFacing.NORTH;

    public TileEntityItemInventoryDirectional(boolean hasSeparateIO) {
        super(hasSeparateIO);
    }
