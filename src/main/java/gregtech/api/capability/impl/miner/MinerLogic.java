...
public class MinerLogic {
    ...
    private void mineAndInsertItems(NonNullList<ItemStack> blockDrops, WorldServer world) {
        ...
        if (InventoryUtils.addItemsToItemHandler(metaTileEntity.getExportItems(), true, blockDrops)) {
            InventoryUtils.addItemsToItemHandler(metaTileEntity.getExportItems(), false, blockDrops);
