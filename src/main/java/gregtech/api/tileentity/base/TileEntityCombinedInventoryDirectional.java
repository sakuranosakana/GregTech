...
public abstract class TileEntityCombinedInventoryDirectional extends TileEntityCombinedInventory implements ITileEntityRotatable {

    protected EnumFacing frontFacing = EnumFacing.NORTH;

    public TileEntityCombinedInventoryDirectional(boolean hasSeparateIO) {
        super(hasSeparateIO);
    }
