...
import static gregtech.apiOld.util.Predicates.not;
import static gregtech.apiOld.util.Predicates.or;
import static gregtech.apiOld.util.StreamUtils.streamFrom;
