...
import gregtech.api.metatileentity.interfaces.IMachineHatchMultiblock;
...
public class MetaTileEntityMachineHatch extends MetaTileEntityMultiblockNotifiablePart implements IMultiblockAbilityPart<IItemHandlerModifiable> {
    ...
    public ModularUI createUI(EntityPlayer entityPlayer) {
        ...
        return builder.bindPlayerInventory(entityPlayer.inventory, GuiTextures.SLOT, 7, 18 + 18 + 12).build(getTileEntity(), entityPlayer);
    }
