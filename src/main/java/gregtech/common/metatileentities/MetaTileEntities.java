...
import gregtech.apiOld.metatileentity.SimpleGeneratorMetaTileEntity;
...
public class MetaTileEntities {
    ...
    public static <T extends MetaTileEntity> T registerMetaTileEntity(int id, T sampleMetaTileEntity) {
        ...
        if (sampleMetaTileEntity instanceof MultiblockControllerBase && GregTechAPI.moduleManager.isModuleEnabled(GregTechModules.MODULE_JEI)) {
