package gregtech.apiOld.terminal.app;

import gregtech.apiOld.gui.resources.IGuiTexture;
import gregtech.apiOld.gui.resources.ResourceHelper;
import gregtech.apiOld.gui.resources.TextureArea;
import gregtech.apiOld.terminal.TerminalRegistry;
import gregtech.apiOld.terminal.gui.widgets.AnimaWidgetGroup;
...
public abstract class AbstractApplication extends AnimaWidgetGroup {
     ...
     * Due to INative's poor synchronization, do not add the INativeWidget {@link gregtech.apiOld.gui.INativeWidget} here.
